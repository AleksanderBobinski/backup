...
AddPackage ruby-highline # A higher level command-line oriented interface
...
AddPackage doxygen-docs # Developer documentation for doxygen
...
AddPackage flann # A library for performing fast approximate nearest neighbor searches in high dimensional spaces
AddPackage flex # A tool for generating text-scanning programs
AddPackage fpc # Free Pascal Compiler, Turbo Pascal 7.0 and Delphi compatible.
AddPackage freeglut # Provides functionality for small OpenGL programs
...
AddPackage indent # C language source code formatting program
...
AddPackage java-batik # SVG library for Java
...
AddPackage kaccounts-providers # Online account providers for the KAccounts system
AddPackage kactivitymanagerd # System service to manage user activities and track the usage patterns
AddPackage kde-cli-tools # Tools based on KDE Frameworks 5 to better interact with the system
AddPackage kde-dev-scripts # Scripts and setting files useful during development of KDE software
AddPackage kde-dev-utils # Small utilities for developers using KDE/Qt libs/frameworks
...
AddPackage kdecoration # Plugin based library to create window decorations
...
AddPackage libc++abi # Low level support for the LLVM C++ standard library.
AddPackage libkscreen # KDE screen management software
AddPackage libksysguard # Library to retrieve information on the current status of computer hardware
...
AddPackage licenses # A set of common license files
...
AddPackage makedumpfile # A tool to generate smaller dumpfiles from kdump memory dumps
AddPackage man-db # A utility for reading man pages
AddPackage man-pages # Linux man pages
AddPackage markdownpart # KPart for rendering Markdown content
AddPackage mdadm # A tool for managing/monitoring Linux md device arrays, also known as Software RAID
AddPackage mdbook # Create book from markdown files, like Gitbook but implemented in Rust
...
AddPackage openmp # LLVM OpenMP Runtime Library
...
AddPackage python-pyaudio # Python bindings for PortAudio
...
AddPackage python-pyqt6-sip # The sip module support for PyQt6
...
AddPackage python-tox # Python virtualenv management and testing tool
AddPackage python-tox-current-env # tox plugin to run tests in current Python environment
AddPackage python-xcffib # Python3 drop in replacement for xpyb, an XCB python binding
AddPackage qemu-system-aarch64 # QEMU system emulator for AARCH64
AddPackage qemu-system-arm # QEMU system emulator for ARM
AddPackage qemu-system-arm-firmware # Firmware for QEMU system emulator for ARM
AddPackage qemu-system-or1k # QEMU system emulator for OpenRisc32
...
AddPackage sdl2_gfx # SDL graphics drawing primitives and other support functions (Version 2)
...
AddPackage sparse # Semantic parser for C
...
AddPackage systemsettings # KDE system manager for hardware, software, and workspaces
...
AddPackage trace-cmd # Interact with Ftrace Linux kernel internal tracer
...
AddPackage virt-firmware # Collection of tools for edk2 firmware images
...
AddPackage weston # Reference implementation of a Wayland compositor
...
AddPackage xed # A small and lightweight text editor. X-Apps Project.
